...
module.exports = (client, guild) => {
    ...
    if (channel.permissionsFor(guild.me).has("EMBED_LINKS")) {
        channel.send(new Discord.MessageEmbed()
            ...
            .setDescription(`PREFIX: \`${prefix}\` | [Click here - Tutorial Video](https://youtu.be/)`)
            ...
            .addField(`\`${config.prefix}tutorial\``, "> *Gives you a Link to the [Tutorial Video](https://youtu.be/)*", true)
